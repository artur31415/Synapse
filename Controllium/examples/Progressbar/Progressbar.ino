...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
[ENG-USA]
    In this example the progressbar that is on the controller, on the Controllium android app, is animated, with its
    progress increment at every two seconds

[PT-BR]
    Neste exemplo a barra de progresso que está no controle, no aplicativo Controllium, é animada, com o seu progresso
    incrementado a cada dois segundos.
**************************************************************************************************************************/
...
//variable used to animate the progressbar
long progressBarLastTime = 0;
...
void loop()
{
  ...
  //increase the progress at every two seconds
  if(millis() - progressBarLastTime > 2000)
  {
    progressBarLastTime = millis();

    //get the actual progressbar value
    double _value = controllium.GetDevice("PROGRESSBAR_0")->GetDoubleValue();
    if(_value + 10 > 100)//100 is the max
      _value = 0;
    else
      _value += 10;

    //set the progressbar value
    controllium.GetDevice("PROGRESSBAR_0")->SetValue(_value);
